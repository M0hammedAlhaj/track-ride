...
public class MaintenanceTimeType {
    ...
    static {
        maintenanceRules.put(MaintenanceType.OIL_CHANGE,
                new MaintenanceRule(10000L, 180));
        maintenanceRules.put(MaintenanceType.BRAKE_INSPECTION,
                new MaintenanceRule(15000L, 365));
        maintenanceRules.put(MaintenanceType.TIRE_ROTATION,
                new MaintenanceRule(8000L, 180));
        maintenanceRules.put(MaintenanceType.TRANSMISSION_SERVICE,
                new MaintenanceRule(60000L, 730));
    }
